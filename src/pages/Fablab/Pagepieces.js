...
function PiecesPage() {
    ...
    const toggleCategory = (category) => {
      setFilteredCategories(prev => {
        ...
        console.log(newSet); // Pour vérifier les catégories filtrées
        return newSet;
      });
      setCurrentPage(1);
    };
    ...
    console.log(filteredItems); // Pour vérifier les éléments filtrés
    ...
    console.log(currentItems); // Pour vérifier les éléments affichés

        ...
        <div className={styles.container}>
            ...
            <img src={im} alt="logo" className={styles.logo} style={{ cursor: 'pointer' }} />
                    ...
                    <SubMenu label="Main Boards" className={styles.SubMenu}>
                        <MenuItem className={styles.widthMenu}><Link to="/club/dashboard">{textMenu(Dashboard,'Dashboard')}</Link></MenuItem>
                    </SubMenu>
                    <SubMenu label="Event" className={styles.SubMenu}>
                        <MenuItem className={styles.widthMenu}><Link to="/club/event">{textMenu(pubIcon,'Publication')}</Link></MenuItem>
                        <MenuItem className={styles.widthMenu}><Link to="/club/Creer">{textMenu(pubilerIcon,'Publier')}</Link></MenuItem>
                    ...
                    <SubMenu label="Paramètres" className={styles.SubMenu}>
                        <MenuItem className={styles.widthMenu}><Link to="/club/profile">{textMenu(profile,'Profile')}</Link></MenuItem>

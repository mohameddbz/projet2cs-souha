  ...
  return (
    <div className={styles.container}>
      <Sidebar className={styles.sidebarContainer}>
        ...
        <img src={im} alt="logo" className={styles.logo} />
          ...
          <SubMenu label="Publication"  className={styles.SubMenu}>
            ...
            <MenuItem className={styles.widthMenu}><Link to="/Admin/publier">{textMenu(pubilerIcon,'Publier')}</Link></MenuItem>
          ...
          <SubMenu label="Paramètres"  className={styles.SubMenu}>
            ...
            <MenuItem className={styles.widthMenu}>{textMenu(deconnect,'Se Deconnecter')}</MenuItem>
          </SubMenu>
        </Menu>
      </Sidebar>
    </div>
